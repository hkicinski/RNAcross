...
server <- function(input, output, session) {
  ...
  #update settings from modal inputs
  ...
  #collect custom species colors from pickers
  observe({
    config <- current_species_config()
    species_list <- sapply(config, function(x) x$short)
    custom <- list()
  ...
  #collect custom species shapes from pickers - stores to custom list which triggers derive
  observe({
    config <- current_species_config()
    species_list <- sapply(config, function(x) x$short)
    custom <- list()
